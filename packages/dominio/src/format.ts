 ...
 *
 * Trazido do sistema web em 12/09/2026 — ele tinha voltado atrás numa versão
 * ainda mais antiga desta mesma regra (que aceitava qualquer sequência de 11
 * dígitos, para não travar cadastro às pressas no portão com documento
 * estrangeiro ou erro de digitação); o motivo da volta foi o oposto: CPF
 * errado sem checksum cria um cadastro "fantasma" que ninguém acha depois.
 */
