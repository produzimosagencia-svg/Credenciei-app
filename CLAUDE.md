...
**376 testes.** `npm run verificar` roda tipos e testes de
...
backlog** (307 tasks, 193 no MVP) — e o do MVP é o que responde "quando dá para usar"; `npm run backlog` calcula os dois — nunca invente número. O que está feito por
