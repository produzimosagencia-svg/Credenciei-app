...
backlog** (291 tasks, 178 no MVP) — e o do MVP é o que responde "quando dá para usar"; `npm run backlog` calcula os dois — nunca invente número. O que está feito por
