...
test('com o segredo certo, apaga a foto de evento fechado há mais de 90 dias', async () => {
  ...
  repo.registros.push({
    ...
    fotoPath: 'ev-hj/part-joao/meio-2025-12-01.jpg', lat: null, lng: null, manual: false, origem: 'app', justificativa: null,
  })
...
test('evento fechado há menos de 90 dias mantém a foto', async () => {
  ...
  repo.registros.push({
    ...
    fotoPath: 'ev-hj/part-joao/meio-2026-09-05.jpg', lat: null, lng: null, manual: false, origem: 'app', justificativa: null,
  })
...
test('sem dataFim configurado, usa dataInicio como o fechamento', async () => {
  ...
  repo.registros.push({
    ...
    fotoPath: 'ev-hj/part-joao/meio-2026-01-01.jpg', lat: null, lng: null, manual: false, origem: 'app', justificativa: null,
  })
