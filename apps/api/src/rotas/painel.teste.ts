...
test('presentes e "ainda não chegaram" somam a equipe e quem já bateu entrada', async () => {
  ...
  repo.registros.push({
    ...
    recebidoEm: '2026-09-05T18:00:00-03:00', fotoPath: null, lat: null, lng: null, manual: false, origem: 'app',
  })
...
test('atividade recente vem da mais nova para a mais velha, e limitada a 10', async () => {
  ...
  for (let i = 0; i < 12; i++) {
    repo.registros.push({
      ...
      recebidoEm: '2026-09-05T10:00:00-03:00', fotoPath: null, lat: null, lng: null, manual: false, origem: 'app',
    })
  }
  const p = await painel(repo, admin.id)
